                ...
                >
                  ...
                  >
                    <div style={{
                      ...
                      <div style={{ 
                        overflow: 'hidden',
                        width: `${COACHES_PER_PAGE * 240 + (COACHES_PER_PAGE - 1) * 40}px`,
                        position: 'relative',
                        height: '180px',
                        display: 'flex',
                        justifyContent: 'flex-start',
                        ...
                        {coaches.map((coach) => (
                          <a href="#" onClick={e => { e.preventDefault(); handleNavigate && handleNavigate(`/coaches?coach=${coach.username}`); }} className="coach-thumb" key={coach._id} style={{ width: '240px', height: '180px', flexShrink: 0, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', overflow: 'hidden', margin: '0', background: 'none', boxShadow: 'none', borderRadius: '8px' }}>
